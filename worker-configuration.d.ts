/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 4b206d6837ce661031c5b6a54eb8ca0a)
// Runtime types generated with workerd@1.20260526.1 2025-09-02 nodejs_compat
interface __BaseEnv_Env {
  CHONK_POKER_DB: D1Database;
  ...
  VITE_MEET_CLOUD_PROJECT_NUMBER: string;
  POKER_ROOM_DURABLE_OBJECT: DurableObjectNamespace<import("./worker-entry").PokerRoomObject>;
}
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./worker-entry");
    durableNamespaces: "PokerRoomObject";
  }
