...
export const SignInModal = ({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) => {
  ...
  return (
    <dialog className={`modal ${isOpen ? "modal-open" : ""}`}>
      <div className="modal-box p-0 bg-transparent shadow-none max-w-sm w-full">
        <div className="card w-full bg-base-200 shadow-2xl border-4 border-base-300 rounded-3xl overflow-hidden">
          <div className="bg-gradient-to-r from-primary/20 to-secondary/20 py-6 px-4">
            <h2 className="text-center text-2xl font-black tracking-tight bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
              Join the Room
            </h2>
