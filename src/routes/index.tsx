...
export const handleCreateRoomServerFn = createServerFn({ method: "POST" })
  .inputValidator((formData) => {
    ...
    return {
      userName: getFormString(formData, FormFieldsEnum.USER_NAME),
      userId: getFormString(formData, FormFieldsEnum.USER_ID),
    };
  })
  .handler(async ({ data }) => {
...
export const handleJoinRoomServerFn = createServerFn({ method: "POST" })
  .inputValidator((formData) => {
    ...
    const roomId = getFormString(formData, FormFieldsEnum.ROOM_ID);
    if (!roomId) {
        ...
        <div className="max-w-md mx-auto pt-8 sm:pt-16 pb-8 flex flex-col gap-6">
          ...
          <div className="card bg-base-200 shadow-xl border-4 border-base-300 rounded-3xl overflow-hidden">
              ...
              <div className="flex justify-between items-center">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-bold text-sm sm:text-base">{sessions.user.name}</p>
                  </div>
                </div>
            ...
            <div className="card-body p-4 sm:p-6">
              ...
              <div className="divider text-xs opacity-50 my-4">or join an existing room</div>
